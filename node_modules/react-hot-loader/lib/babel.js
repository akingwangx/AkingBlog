    ...
    visitor: {
      ...
      Class: function Class(classPath) {
        ...
        classBody.get('body').forEach(function (path) {
          ...
          if (node.key.name !== _constants.REGENERATE_METHOD) {
            hasMethods = true;
          } else {
        ...
        if (hasMethods && !hasRegenerateMethod) {
          var regenerateMethod = t.classMethod('method', t.identifier(_constants.REGENERATE_METHOD), [t.identifier('key'), t.identifier('code')], t.blockStatement([evalTemplate()]));
